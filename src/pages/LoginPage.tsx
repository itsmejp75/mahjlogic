...
export function LoginPage() {
  usePageMeta({
    title: 'Login | MahjLogic',
    description:
      'Sign in to MahjLogic with Google or email to practice American Mah Jongg and use Rack Checker.',
    path: '/login',
  })
    ...
    <main className="landing login-page">
      ...
      <header className="landing__header">
        <div className="landing__header-inner">
          <Link className="landing__brand-mark login-page__brand" to="/" aria-label="Mahj Logic home">
            <img
      ...
      <div className="login-page__shell">
        <div className="login-page__auth-col">
          <section className="landing-auth login-page__card" aria-label="Account">
            {mode !== 'forgot' ? (
              <>
                <div className="landing-auth__google-wrap">
                  <button
                    type="button"
                    className="btn landing-auth__action-btn"
